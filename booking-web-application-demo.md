...
![รูปผลลัพธ์การ Get ข้อมูล](images/บันทึกผลการทดลอง/1.png)
...
![รูปผลลัพธ์การ Get ข้อมูลโดยระบุ ID](images/บันทึกผลการทดลอง/2.png)
...
#### บันทึกรูปผลการรัน
![ผลการรัน](/images/บันทึกผลการทดลอง/7.png)
...
#### บันทึกผลการทดลอง
![รูปหน้าจองห้องพัก ที่แสดงข้อมูลสรุปการจอง](images/บันทึกผลการทดลอง/8.png)
...
### บันทึกผลการทดลอง 
![รูปรายการจองห้องพัก](images/บันทึกผลการทดลอง/9.png)
...
### บันทึกผลการทดลอง
![ผลการแก้ไขข้อมูลการจอง](./images/บันทึกผลการทดลอง/10.png)
...
3) บันทึกผลการทดลอง เมื่อกดปุ่ม "สำหรับผู้ดูแลระบบ"
   ### บันทึกผลการทดลอง
![ผลการแก้ไขข้อมูลการจอง](images/บันทึกผลการทดลอง/11.png)
